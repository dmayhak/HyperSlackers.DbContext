...
namespace HyperSlackers.AspNet.Identity.EntityFramework
{
    ...
    /// </summary>
    public class HyperUserLoginGuid : HyperUserLogin<Guid>
    {
    }
    ...
    /// Entity type for a user's login (i.e. facebook, google) for a multi-tenant <c>DbContext</c>.
    /// </summary>
    public class HyperUserLoginInt : HyperUserLogin<int>
    {
    }
    ...
    /// Entity type for a user's login (i.e. facebook, google) for a multi-tenant <c>DbContext</c>.
    /// </summary>
    public class HyperUserLoginLong : HyperUserLogin<long>
    {
    }
    ...
    public class HyperUserLogin<TKey> : IdentityUserLogin<TKey>, IHyperUserLogin<TKey>
